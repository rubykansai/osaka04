    ...
    contents: [
      {
        ...
        description: 'アジャイルウェアは『Feel Goodな明日をつくる』をミッションに、自慢できるワークスタイルで、はたらく人を応援するサービスを提供中です！ ＼Ruby・Railsエンジニアを積極採用中！副業でのJoinもOK／ ■隔週で週休3日（年間休日150日）■フルフレックス ■リモートワーク ■自社内開発100% ■客先常駐なし ■エディタ、ライブラリ、フレームワーク自由（技術的なことはエンジニアの裁量でおまかせ！）',
        image: 'sponsors/agileware.png',
      },
      {
        name: '株式会社永和システムマネジメント',
        url: 'https://agile.esm.co.jp',
      ...
      {
        name: '株式会社インゲージ',
        url: 'https://www.ingage.co.jp/',
        description: 'インゲージは、「ひとり一人に向き合うをカタチにする」をミッションに顧客対応クラウド『Re:lation（リレーション）』を開発・提供しています。今年創業10周年を迎え、『Re:lation』の導入社数は5,000社を突破しました。「使っていて楽しい」「導入して良かった」を感じていただけるサービスの提供を第一に、これからも企業の業務効率化・可視化の実現と人材教育に貢献します。',
      ...
      },
      {
        ...
        description: 'ポノスは、1990年の創業以来ゲームを通してエンターテインメントという文化の発展に貢献してまいりました。【求められるモノは創らない、それ以上を創り出す。】を掲げ、自分たちしか創れない価値をプラスしていくことを大切にしています。現在は、オリジナルゲーム開発を核に事業を展開し、代表タイトル『にゃんこ大戦争』は、累計DL8,200万を（2023年5月現在）超え、多くのお客様に楽しんでいただいております。',
